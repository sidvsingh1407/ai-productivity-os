...
@router.post("/export/{audit_id}", response_model=schemas.ExportJobResponse, dependencies=[Depends(require_role("member"))])
...
@router.get("/status/{job_id}", response_model=schemas.ExportJobResponse, dependencies=[Depends(require_role("viewer"))])
...
@router.get("/download/{report_id}", dependencies=[Depends(require_role("viewer"))])
